...
public class TourToolWindow {
    ...
    private void updateHtml(TourStep step) {
        ...
        if (step.aiExplanation() != null && !step.aiExplanation().isBlank()) {
            ...
            // Only show author note if it exists, skip code snippet display
            content = "<table width='100%' cellpadding='8' cellspacing='0' style='margin-bottom: 12px;'>" +
                    "<tr><td style='background-color: #dbeafe; border-left: 3px solid #3b82f6;'>" +
                    "<b>" + escape(step.authorNote()) + "</b></td></tr></table>";
        } else {
        ...
        String styledHtml = "<html><head><style>" +
                ...
                "pre { background-color: " + codeBlockBg + "; padding: 12px; " +
                "font-family: monospace; font-size: 12pt; margin-top: 8px; margin-bottom: 8px; }" +
